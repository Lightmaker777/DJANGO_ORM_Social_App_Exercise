    ...
    operations = [
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        ...
                        unique=True,
                        validators=[
                            social_app.models.validate_bad_words,
                ...
                (
                    ...
                    models.EmailField(
                        ...
                        unique=True,
                        validators=[
                            social_app.models.valide_email,
                ...
                (
                    "bio",
                    models.TextField(
                        blank=True, validators=[social_app.models.validate_bad_words]
                    ),
                ),
                ...
                (
                    ...
                    models.PositiveIntegerField(
                        null=True, validators=[social_app.models.validate_age]
                    ),
                ),
                (
                    "password",
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE, to="social_app.user"
            ),
        ),
    ]
